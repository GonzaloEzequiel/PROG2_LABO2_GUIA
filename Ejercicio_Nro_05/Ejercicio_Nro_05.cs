...
{
    internal class Ejercicio_Nro_05
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 1; i < numero; i++)
            {
                ...
                //si ambas sumas son iguales, se cumple la condicion, y el centro numérico es la actual iteración
                if (sumaIzq == sumaDer)
                {
